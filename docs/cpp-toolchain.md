...
capabilities, plus the `DumpAccessibilityTree` of the subsection below, and nothing else — under the names in
the table below, where theirs is the only `CreateScreenshot` in this section and the command this platform
answers to is `TakeScreenshot`.
