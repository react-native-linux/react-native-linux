 ...
 * vendored React Native — whose shell scripts are not ours to lint and which exist only once something has
 * been built, so without them `pnpm validate` passes on a fresh checkout and fails on a working one.
 */
