...
- **Skia-on-RN precedent:** `microsoft/react-native-skia` (archived experiment) for RN-core-to-Skia rendering shape and its limitations; treat as prior art, not gospel.
